 ...
 */
class Controller_Register extends SwiftLogin_Controller
{
		...
		*/
		...
		if($_POST)
		{
			...
			else
			{
				...
				$this->content = new View('register/email_sent', 'swiftlogin');
		...
		$this->content = new View('register/form', 'swiftlogin');
