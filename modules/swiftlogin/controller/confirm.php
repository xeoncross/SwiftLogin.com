...
class Controller_Confirm extends SwiftLogin_Controller
{
	...
	function index()
	{
		...
		{
			$this->content = new View('verify/logged_in', 'swiftlogin');
			return;
		}
		...
		if( ! $user)
		{
			...
			$this->content = new View('verify/not_found', 'swiftlogin');
			return;
		}
		...
		// Success
		$this->content = new View('verify/done', 'swiftlogin');
