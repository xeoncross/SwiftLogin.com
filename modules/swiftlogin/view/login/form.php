...
<form method="post" id="login">
		...
		<input tabindex="1" type="text" name="email" id="email" value="<?php print h(post('email'));?>" class="text shadow" />
		...
		*/
		...
		<label for="email"><span><a href="/account/forgot_password">Forgot your Password?</a></span>Very Complex Password</label>
